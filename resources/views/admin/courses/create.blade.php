...
<div class="mb-6">
    <div class="flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-gray-600">Add a new course to the platform</p>
        </div>
    </div>
</div>
        ...
        <div class="mt-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                <div class="flex items-center">
                    <input type="checkbox" id="country_in" name="countries[]" value="in" {{ in_array('in', old('countries', [])) ? 'checked' : '' }}
                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    <label for="country_in" class="ml-2 block text-sm text-gray-900">India</label>
                </div>
                <div class="flex items-center">
                    <input type="checkbox" id="country_uk" name="countries[]" value="uk" {{ in_array('uk', old('countries', [])) ? 'checked' : '' }}
                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    <label for="country_uk" class="ml-2 block text-sm text-gray-900">United Kingdom</label>
                </div>
                <div class="flex items-center">
                    <input type="checkbox" id="country_us" name="countries[]" value="us" {{ in_array('us', old('countries', [])) ? 'checked' : '' }}
                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    <label for="country_us" class="ml-2 block text-sm text-gray-900">United States</label>
                </div>
                <div class="flex items-center">
                    <input type="checkbox" id="country_ca" name="countries[]" value="ca" {{ in_array('ca', old('countries', [])) ? 'checked' : '' }}
                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    <label for="country_ca" class="ml-2 block text-sm text-gray-900">Canada</label>
                </div>
                <div class="flex items-center">
                    <input type="checkbox" id="country_au" name="countries[]" value="au" {{ in_array('au', old('countries', [])) ? 'checked' : '' }}
                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
