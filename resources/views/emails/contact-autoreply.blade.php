...
<head>
    ...
    <title>Thank you for contacting Fateh Science Villa</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Thanks for reaching out to <strong>Fateh Science Villa</strong>. Our support team has received your message and will get back to you via email or WhatsApp within the next 24 hours.</p>
            ...
            <a class="btn" href="{{ url('/'.$data['country'].'/home') }}">Visit Fateh Science Villa</a>
        </div>
        <div class="footer">
